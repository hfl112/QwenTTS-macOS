...
final class MockBackend {
    ...
    func respond(method: String, path: String, body: [String: Any]?) -> (Int, Data?) {
        ...
        case ("GET", "/saved_items"):
            // #10 C6.3:字段对齐真实 wire(SavedItem 类型化解码的 parity 由测试钉住)
            return json([[
                "timestamp": 1_751_600_000.0, "text": "Mock 保存内容", "title": "Mock 保存项",
                "source": "web", "voice": "Serena", "is_exported": false,
                "md5": "mockmd5", "mode": "original", "is_pinned": false,
            ]])
        ...
        case ("GET", "/podcasts/list"):
            return json([[
                "title": "Mock Podcast", "filename": "mock_podcast.wav",
                "timestamp": 1_751_600_000.0, "is_pending": false, "source": "web",
                "is_pinned": false, "size_mb": 1.2,
            ]])
        ...
        case ("GET", "/cache/items"):
            return json([[
                "md5": "cachemd5", "text": "Mock 缓存内容", "model": "mock-model",
                "voice": "Serena", "duration": 2.5, "created_at": 1_751_600_000.0,
    ...
    private func podcastJobsFixture() -> [[String: Any]] {
        let base: [String: Any] = [
            "job_id": "podjob-mock", "title": "Mock Podcast",
            "kind": "single", "md5": "mockmd5", "source": "web",
            "created_at": 1_751_600_000.0, "updated_at": 1_751_600_001.0,
        ]
        switch failure {
        case .llmNoKey:
